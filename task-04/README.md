First I tried using the online complier. After debugging few errors in the code, it showed the exception 'No X11 DISPLAY variable was set, but this program performed an operation which requires it.'
